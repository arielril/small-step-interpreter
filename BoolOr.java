 ...
 * BoolOr
 */
public class BoolOr extends BoolExpression {
  private BoolExpression e1;
  private BoolExpression e2;

  public BoolOr(BoolExpression e1, BoolExpression e2) {
    this.e1 = e1;
    this.e2 = e2;
  }
  ...
  BoolExpression smallStep(Environment a) {
    if (!(e1 instanceof BoolVal))
      return new BoolOr(e1.smallStep(a), e2);
    else if (!(e2 instanceof BoolVal))
      return new BoolOr(e1, e2.smallStep(a));
    else
